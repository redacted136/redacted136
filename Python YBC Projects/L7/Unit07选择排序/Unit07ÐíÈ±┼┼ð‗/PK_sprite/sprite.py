...
class Sprite:
    ...
    def __show_image(self, image):
        ...
        if self.type == 0:     # 火龙
            ...
            topleft = (mod_1(80-20), mod_1(HEIGHT-450-30)) if self.left else (mod_1(WIDTH-350+20), mod_1(HEIGHT-450-30))  #
        elif self.type == 2:   # 木龙
            size = (mod_1(280+20), mod_1(250+20))
    ...
    def __show_blood(self):
        ...
        name_rect.topleft = mods_1(120, 650) if self.left else mods_1(750, 650)
