...
# 游戏画面尺寸
SIZE = WIDTH, HEIGHT = mods_1(1024, 768)

# 常用字体
FONT_YT_50 = pygame.font.Font(os.path.join(ROOT_DIR, 'font/yuanti.TTF'), mod_1(50))
FONT_YT_30 = pygame.font.Font(os.path.join(ROOT_DIR, 'font/yuanti.TTF'), mod_1(20))
FONT_FZ_60 = pygame.font.Font(os.path.join(ROOT_DIR, 'font/fzytj.ttf'), mod_1(60))
FONT_FZ_30 = pygame.font.Font(os.path.join(ROOT_DIR, 'font/fzytj.ttf'), mod_1(30))
